...
locals {
  ...
  # Inbound Ports for Web Subnet (e.g. SSH, ChromaDB)
  web_inbound_ports_map = {
    "120" = "22"     # SSH
    "130" = "8000"   # Chroma DB
  }

  # Inbound Ports for App Gateway Subnet
  ag_inbound_ports_map = {
    "100" = "80"               # HTTP
    "110" = "443"              # HTTPS
    "130" = "65200-65535"      # App Gateway Backend Pool Ports
  }
}
...
# Inbound NSG Rules for Web Subnet
...
# Inbound NSG Rules for App Gateway Subnet
...
# Associate App Gateway NSG with Subnet
